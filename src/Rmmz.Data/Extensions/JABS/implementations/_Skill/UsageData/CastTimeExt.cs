...
public static class CastTimeExt
{
    ...
    {
        return skill.GetFirstNumberByTag(Models.JABS.Tags.CastTime.Name) ?? decimal.Zero;
    }
    ...
    public static void UpdateJabsCastTime(this RPG_Skill skill, decimal castTime)
    {
        ...
        if (castTime == 0)
        {
            ...
            skill.RemoveNoteData(Models.JABS.Tags.CastTime.Regex);
        ...
        var updatedNote = Models.JABS.Tags.CastTime.ToValueTag(castTime.ToString());
        ...
        else
        {
            ...
            skill.UpdateNoteData(Models.JABS.Tags.CastTime.Regex, updatedNote);
        }
    }
}