...
public static class Tags
{
    ...
    private static Tag skillId()
    {
        var tag = "skillId";
        var regex = @"<skillId:[ ]?(\d+)>";
        var description = "The id of the skill triggered when this weapon is used in combat.\n"
            + "\n"
    ...
    private static Tag radius()
    {
        ...
        var description = "The radius or range of this skill.\n"
    ...
    private static Tag proximity()
    {
        ...
        var description = "The proximity or maximum casting distance of this skill.\n"
    ...
    private static Tag hitbox()
    {
        ...
        var description = "The hitbox represents the shape of the collision vector for this skill.\n\n"
    ...
    private static Tag combo()
    {
        var tag = "combo";
        var regex = @"<combo:[ ]?(\[\d+,[ ]?\d+])>";
        var skillDescription = "The combo skill defines what skills will become enabled upon execution of this skill.\n"
            + "\n"
    ...
    private static Tag pierce()
    {
        ...
        var countDescription = "The total number of times this skill can connect with targets before expiring.";
        var delayDescription =
    ...
    private static Tag pose()
    {
        ...
        var suffixDescription =
            ...
            + "is 'hero-atk.png'.";
        var indexDescription = "The index of the spritesheet to use.\n"
    ...
    private static Tag speedBoost()
    {
        ...
        var description = "The additive percent-based speedboost provided.\n"
    ...
    private static Tag sight()
    {
        ...
        var description = "The sight of this battler.\n"
    ...
    private static Tag alertedSightBoost()
    {
        ...
        var description = "The sight bonus when this battler is alerted.\n"
    ...
    private static Tag pursuit()
    {
        ...
        var description = "The pursuit of this battler.\n"
    ...
    private static Tag aiTraitCareful()
    {
        ...
        var description = "Whether or not this battler has the AI trait of 'careful'.";
        return new(tag, regex, description);
    }
    ...
    private static Tag aiTraitExecutor()
    {
        ...
        var description = "Whether or not this battler has the AI trait of 'executor'.";
        return new(tag, regex, description);
    }
    ...
    private static Tag aiTraitReckless()
    {
        ...
        var description = "Whether or not this battler has the AI trait of 'reckless'.";
        return new(tag, regex, description);
    }
    ...
    private static Tag aiTraitHealer()
    {
        ...
        var description = "Whether or not this battler has the AI trait of 'healer'.";
        return new(tag, regex, description);
    }
    ...
    private static Tag aiTraitLeader()
    {
        ...
        var description = "Whether or not this battler has the AI trait of 'leader'.";
        return new(tag, regex, description);
    }
    ...
    private static Tag aiTraitFollower()
    {
        ...
        var description = "Whether or not this battler has the AI trait of 'follower'.";
        return new(tag, regex, description);
    }
}