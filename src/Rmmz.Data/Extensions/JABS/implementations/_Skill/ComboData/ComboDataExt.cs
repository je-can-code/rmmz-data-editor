...
using ComboDataRecord = JMZ.Rmmz.Data.Models.JABS.ComboData;
...
internal static class ComboDataExt
{
    internal static ComboDataRecord GetJabsComboData(this RPG_Skill skill)
    {
        ...
        var comboData = skill.GetAllNumbersByTag(Models.JABS.Tags.Combo.Name) ?? new List<decimal>();
    ...
    internal static void UpdateJabsComboData(this RPG_Skill skill, decimal comboSkill, decimal comboDelay)
    {
        ...
        if (comboSkill == 0)
        {
            ...
            skill.RemoveNoteData(Models.JABS.Tags.Combo.Regex);
        ...
        var updatedNote = Models.JABS.Tags.Combo.ToArrayTag(comboSkill.ToString(), comboDelay.ToString());
        ...
        else
        {
            ...
            skill.UpdateNoteData(Models.JABS.Tags.Combo.Regex, updatedNote);
        }
    }
}