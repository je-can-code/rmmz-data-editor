...
public static class ParameterMapper
{
    ...
    public static string NameFromLongParameterId(int longParameterId) => longParameterId switch
    {
        // bparam IDs 0-7.
    ...
    private static string ToBparamName(int bparamId) => bparamId switch
    {
        0 => "MaxLife",
        1 => "MaxMagi",
        2 => "Power",
    ...
    private static string ToXparamName(int xparamId) => xparamId switch
    {
        0 => "Accuracy",
        1 => "Parry Extend",
        2 => "Crit Rate",
    ...
    private static string ToSparamName(int sparamId) => sparamId switch
    {
        0 => "Aggro",
        1 => "Parry",
        2 => "Healing Rate",
    ...
    private static string ToCustomName(int cparamId) => cparamId switch
    {
        0 => "Crit Amp",
        1 => "Crit Block",
        2 => "Max Tech",
