...
public static class CastAnimationExt
{
    ...
    {
        return skill.GetFirstNumberByTag(Models.JABS.Tags.CastAnimation.Name) ?? decimal.Zero;
    }
    ...
    public static void UpdateJabsCastAnimation(this RPG_Skill skill, decimal castAnimationId)
    {
        ...
        if (castAnimationId == 0)
        {
            ...
            skill.RemoveNoteData(Models.JABS.Tags.CastAnimation.Regex);
        ...
        var updatedNote = Models.JABS.Tags.CastAnimation.ToValueTag(castAnimationId.ToString());
        ...
        else
        {
            ...
            skill.UpdateNoteData(Models.JABS.Tags.CastAnimation.Regex, updatedNote);
        }
    }
}