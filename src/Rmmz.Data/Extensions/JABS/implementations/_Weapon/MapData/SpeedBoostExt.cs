...
namespace JMZ.Rmmz.Data.Extensions.JABS.implementations._Weapon.MapData;

public static class SpeedBoostExt
{
    public static decimal GetJabsSpeedBoost(this RPG_Weapon skill)
    {
        return skill.GetFirstNumberByTag(Models.JABS.Tags.SpeedBoost.Name) ?? decimal.Zero;
    }
    ...
    public static void UpdateJabsSpeedBoost(this RPG_Weapon skill, decimal speedBoost)
    {
        ...
        if (speedBoost == 0)
        {
            ...
            skill.RemoveNoteData(Models.JABS.Tags.SpeedBoost.Regex);
        ...
        var updatedNote = Models.JABS.Tags.SpeedBoost.ToValueTag(speedBoost.ToString());
        ...
        else
        {
            ...
            skill.UpdateNoteData(Models.JABS.Tags.SpeedBoost.Regex, updatedNote);
        }
    }
}