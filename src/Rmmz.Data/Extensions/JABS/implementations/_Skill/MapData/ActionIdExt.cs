...
public static class ActionIdExt
{
    ...
    {
        return skill.GetFirstNumberByTag(Models.JABS.Tags.ActionId.Name)  ?? decimal.Zero;
    }
    ...
    public static void UpdateJabsActionId(this RPG_Skill skill, decimal actionId)
    {
        ...
        if (actionId == 0)
        {
            ...
            skill.RemoveNoteData(Models.JABS.Tags.ActionId.Regex);
        ...
        var updatedNote = Models.JABS.Tags.ActionId.ToValueTag(actionId.ToString());
        ...
        else
        {
            ...
            skill.UpdateNoteData(Models.JABS.Tags.ActionId.Regex, updatedNote);
        }
    }
}