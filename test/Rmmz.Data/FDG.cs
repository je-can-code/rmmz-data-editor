...
public class FDG
{
    ...
    public string SkillIdTag(int? input = null)
    {
        ...
        var builtTag = Data.Models.JABS.Tags.SkillId.ToValueTag(tagValue.ToString());
        return builtTag;
    }
    ...
    public string SpeedBoostTag(int? input = null)
    {
        ...
        var builtTag = Data.Models.JABS.Tags.SpeedBoost.ToValueTag(tagValue.ToString());
        return builtTag;
    }
    ...
    {
        var tagValue = input ?? RmmzUNumber();
        var builtTag = Data.Models.JABS.Tags.Cooldown.ToValueTag(tagValue.ToString());
        return builtTag;
    }
    ...
    {
        var tagValue = input ?? RmmzUNumber();
        var builtTag = Data.Models.JABS.Tags.CastAnimation.ToValueTag(tagValue.ToString());
        return builtTag;
    }
    ...
    {
        var tagValue = input ?? RmmzUNumber();
        var builtTag = Data.Models.JABS.Tags.CastTime.ToValueTag(tagValue.ToString());
        return builtTag;
    }
    ...
    {
        var tagValue = input ?? RmmzUNumber();
        var builtTag = Data.Models.JABS.Tags.ActionId.ToValueTag(tagValue.ToString());
        return builtTag;
    }
    ...
    {
        var tagValue = input ?? RmmzUNumber();
        var builtTag = Data.Models.JABS.Tags.Duration.ToValueTag(tagValue.ToString());
        return builtTag;
    }
